...
class MultipleChoiceWithPicturesPage extends StatefulWidget {
  final int courseId;
  final int lessonId;
  final int questionId;
  final ValueChanged<int> onOptionSelected;

  const MultipleChoiceWithPicturesPage({
    super.key,
  ...
  @override
  State<MultipleChoiceWithPicturesPage> createState() =>
      _MultipleChoiceWithPicturesPageState();
}

class _MultipleChoiceWithPicturesPageState
    extends State<MultipleChoiceWithPicturesPage> {
  int? selectedId;

  @override
  void initState() {
    super.initState();
    context.read<MultipleChoiceWithPicturesBloc>().add(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<
        MultipleChoiceWithPicturesBloc,
        MultipleChoiceWithPicturesState
      >(
        builder: (context, state) {
          if (state is MultipleChoiceWithPicturesLoaded) {
