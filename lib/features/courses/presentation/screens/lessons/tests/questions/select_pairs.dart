...
class SelectPairs extends StatefulWidget {
  final int courseId;
  final int lessonId;
  ...
  @override
  State<SelectPairs> createState() => _SelectPairsState();
}

class _SelectPairsState extends State<SelectPairs> {
  ...
  void _onAnswerSuccess() {
    ...
    final totalPairs =
        context.read<SelectPairsBloc>().state is SelectPairsLoaded
            ? (context.read<SelectPairsBloc>().state as SelectPairsLoaded)
                .response
                .data
                .options
                .length
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<AnswerSelectPairsBloc, AnswerSelectPairsState>(
        ...
        child: BlocBuilder<SelectPairsBloc, SelectPairsState>(
          builder: (context, state) {
            if (state is SelectPairsLoading) {
              return Padding(
            ...
            } else if (state is SelectPairsError) {
              return Center(child: Text('Error loading question'));
            } else if (state is SelectPairsLoaded) {
